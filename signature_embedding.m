...
[LL_1, HL_1, LH_1, HH_1] = dwt2(LL, 'db1');    % 1st step DWT
[LL_2, HL_2, LH_2, HH_2] = dwt2(LL_1, 'db1');  % 2nd step DWT
[LL_3, HL_3, LH_3, HH_3] = dwt2(LL_2, 'db1');  % 3rd step DWT
[LL_4, HL_4, LH_4, HH_4] = dwt2(LL_3, 'db1');  % 4rth step DWT
...
for p = 1:length(integer_part)
    ...
    binary_coefficients{p} = de2bi(integer_part(p), 16);
end
...
for x = 1:length(binary_coefficients)
    bin2decimal(x) = bi2de(double(binary_coefficients{1, x}));
end
...
% Clear workspace
clear('LL_1', 'LL_2', 'LL_3', 'LL_4', 'HH_4', 'combined_LL4_and_HH4_coef','negative_idxs', 'combined_LL4_and_HH4_coeff_pos', 'integer_part','fraction_part', 'binary_coefficients', 'signature');
...
% Clear workspace
clear('LL_1_inv', 'LL_2_inv', 'LL_3_inv', 'LL_4_modified', 'HL_1', 'HL_2', 'HL_3', 'HL_4', 'LH_1', 'LH_2', 'LH_3', 'LH_4', 'HH_1', 'HH_2', 'HH_3', 'HH_4_modified');

...
function reconstructed_signature = signature_extraction(LLw, lengthOfWatermark)
...
% Clear workspace
clear('LLw_4', 'HHw_4', 'combined_LLw_4_and_HHw_4_coeff', 'negative_watermarked_idxs', 'fraction_part_of_watermarked_image');
...
for y = 1:length(combined_LLw_4_and_HHw_4_coeff_pos)
    ...
    binary_watermarked_coefficients{y} = de2bi(integer_part_of_watermarked_image(y), 16);
end
